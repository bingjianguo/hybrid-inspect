import { VORLONYTPE } from './vorlon.domExplorer.interfaces';
import ClientCommands from './components/ClientCommands';

declare var $: any;
declare var VORLON: VORLONYTPE;

const { Core, ClientPlugin, PackagedNode } = VORLON;
...
DOMExplorerClient.prototype.ClientCommands = ClientCommands;

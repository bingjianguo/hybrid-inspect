...
module VORLON {
    export class ObjectExplorerClient extends ClientPlugin {
        ...
        private inspect(path: Array<string>, obj: any, context: any): ObjExplorerObjDescriptor {
            ...
            for (var i = 0, l = objProperties.length; i < l; i++) {
                ...
                try {
                    ...
                    if (propertyType === 'function') {
                        // ObjectExplorer过程会导致在websocket传输过程数据过大, 暂时移除对functions的上报
            ...
            //if ( res.functions.length > 50) {
            //    res.functions = res.functions.slice(0, 50);
            //}
            ...
            //if ( res.properties.length > 50) {
            //    res.properties = res.properties.slice(0, 50);
            //}

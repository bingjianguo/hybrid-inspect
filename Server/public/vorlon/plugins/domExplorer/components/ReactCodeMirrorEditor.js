...
class ReactCodeMirrorEditor extends React.Component {
  constructor(props) {
    super(props);
  }
  ...
  componentDidMount() {
    ...
    const editor = this.editor = CodeMirror(this.rootEle, {
      mode: "htmlmixed",
      htmlMode: true,
      value: code,

...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";var _classCallCheck2 = __webpack_require__(9);var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);var _possibleConstructorReturn2 = __webpack_require__(15);var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);var _inherits2 = __webpack_require__(14);var _inherits3 = _interopRequireDefault(_inherits2);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _VORLON = VORLON,Core = _VORLON.Core,DashboardPlugin = _VORLON.DashboardPlugin,Tools = _VORLON.Tools;var
	NetworkMonitorDashboard = function (_DashboardPlugin) {(0, _inherits3.default)(NetworkMonitorDashboard, _DashboardPlugin);
	    function NetworkMonitorDashboard() {(0, _classCallCheck3.default)(this, NetworkMonitorDashboard);var _this = (0, _possibleConstructorReturn3.default)(this,
	        _DashboardPlugin.call(this, "networkMonitor", "control.html", "control.css"));
	        _this._ready = false;
	        _this._id = "NETWORK";
	        //this.debug = true;
	        _this._dashboardDiv = null;return _this;
	    }NetworkMonitorDashboard.prototype.
	    startDashboardSide = function startDashboardSide() {var _this2 = this;var div = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
	        ...
	        this._insertHtmlContentAsync(div, function (filledDiv) {
	            _this2._containerDiv = Tools.QuerySelectorById(_this2._dashboardDiv, "networkLogList");
	            _this2._ready = true;
	        });
	    };NetworkMonitorDashboard.prototype.
	    processEntries = function processEntries(receivedObject) {
	    ...
	    createBar = function createBar(x, width, color) {
	        ...
	        return bar;
	    };return NetworkMonitorDashboard;}(DashboardPlugin);

	NetworkMonitorDashboard.prototype.DashboardCommands = {
	    performanceItems: function performanceItems(data) {
	        var plugin = this;

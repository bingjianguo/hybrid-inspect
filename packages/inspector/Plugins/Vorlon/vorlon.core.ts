...
import { VorlonMessage, ClientMessenger } from './vorlon.clientMessenger';
import { RuntimeSide } from './vorlon.enums';
import { Tools } from './vorlon.tools';
import { BasePlugin } from './vorlon.basePlugin';
export class _Core {
  ...
  public sendHelo(){
    ...
    } else if ( (<any>window).vorlonTitle ) {
      title =  (<any>window).vorlonTitle;
    } else {
      title = '-NoTitle-';
    }

...
export module VORLON {
  ...
  export class Client {
    ...
    public opened: boolean; // 窗口及对应的webview被关闭
    public ua: string;
    public icon: string;
    public name: string;
    ...
    constructor(clientId: string, ua: string, noWindow: boolean, socket: SocketIO.Socket, displayId: number,  url: string, title: string, opened: boolean = true) {

              ...
              parser.encodePacket(packet, self.supportsBinary, function (data) {
                ...
                try {
                  if (self.usingBrowserWebSocket) {
                    ...
                    // To Be Continue
                    // ios safari max length of websocket send info
                    // http://stackoverflow.com/questions/43194869/how-to-work-around-safari-10-1-error-failed-to-send-websocket-frame
                    //if (data.length > 23085) {
                    //  debugger;
                    //} else
                    //  self.ws.send(data);
                    if (data.length > 23085) {
